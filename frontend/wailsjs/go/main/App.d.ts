...
import {zeek} from '../models';
import {pcap} from '../models';
import {models} from '../models';

export function AnalyzePCAP(arg1:zeek.AnalyzePCAPRequest):Promise<zeek.AnalyzeResult>;
...
export function CheckZeekHealth():Promise<Record<string, any>>;
...
export function GetZeekVersion():Promise<string>;

export function GetZeekVersions():Promise<Record<string, any>>;
...
export function IsZeekEnabled():Promise<boolean>;
